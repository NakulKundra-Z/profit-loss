          ...
          {filteredBlogs.length > 0 ? (
            <div className="blog-grid" style={{ marginTop: '40px' }}>
              {filteredBlogs.map(blog => {
                ...
                // Select image based on category or default
                let coverImg = "/wp-content/uploads/2025/03/Site-Stats-amico.png";
                if (category === 'Investing') coverImg = "/wp-content/uploads/2025/03/Investment-data-amico.png";
                else if (category === 'Psychology') coverImg = "/wp-content/uploads/2025/03/Financial-data-amico.png";
